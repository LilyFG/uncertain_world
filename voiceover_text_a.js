var vo_txt = {
  ...
  spaceman_init: "Here is the inside of the space ship. Can you see your face, in the spaceship window? "+
    "If not, you may need to move the camera. "+
  ...
  sam_rate: "How happy or unhappy "+
    ...
    "The purple person is very unhappy on the left "+
    "and the yellow person is very happy on the right. "+
    "Press the button with the person that feels how you are feeling now.",
  // worry rating
